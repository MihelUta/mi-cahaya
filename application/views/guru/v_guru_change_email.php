...
<div class="container">            
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Ubah Email <small>MI Cahaya</small></h2><hr>
                ...
                <div class="x_content"><br />
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= site_url('add_email_guru'); ?>" method="POST">
