...
<head>
    ...
    <link href="<?= base_url(); ?>assets/css/header_guru.css" rel="stylesheet">
...
<!--       <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
 ...
 -->
      <a class="navbar-brand" href="#">
        <img src="<?= base_url() ?>assets/image/logo/logo.png" style="width: 110px; height: 60px; margin-top: -15px;">
      </a>
        ...
        <li><a href="<?php base_url() ?>login/logout"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
                ...
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="<?= site_url('guru'); ?>" title="Home Siswa"><span class="glyphicon glyphicon-home"></span> Home Guru</a></li>
                    <li><a href="<?= site_url('settings_guru'); ?>" title="Pengaturan"><span class="glyphicon glyphicon-cog"></span> Pengaturan</a></li>
